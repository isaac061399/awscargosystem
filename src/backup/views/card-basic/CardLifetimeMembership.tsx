    ...
    <Card>
      <Grid container>
            ...
            <Grid container>
              <Grid size={{ xs: 12, sm: 6 }} className="flex flex-col pie-5 gap-[26px]">
                <div className="flex items-center gap-2.5">
                  <div className="flex">
                    <i className="ri-lock-unlock-line text-xl text-secondary" />
                  </div>
                  <Typography>Full Access</Typography>
                </div>
                <div className="flex items-center gap-2.5">
                  <div className="flex">
                    <i className="ri-user-3-line text-xl text-secondary" />
                  </div>
        ...
        <Grid size={{ xs: 12, sm: 5 }}>
          <CardContent className="flex items-center justify-center bs-full bg-action-hover">
