...
const AppReactApexCharts = dynamic(() => import('@components/apex-charts/AppReactApexCharts'));
  ...
  return (
    <Card>
      <CardHeader
        ...
        action={<OptionsMenu iconClassName="text-primary" options={['Refresh', 'Update', 'Delete']} />}
      />
