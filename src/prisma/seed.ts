...
const permissions = [
  ...
  { id: 'cash-registers.reopen', name: 'Reopen' },
  { id: 'cash-registers.view', name: 'View' },
  { id: 'clients.create', name: 'Create' },
  { id: 'clients.delete', name: 'Delete' },
  { id: 'clients.edit', name: 'Edit' },
  { id: 'clients.list', name: 'List' },
  { id: 'configuration.edit', name: 'Edit' },
  { id: 'configuration.view', name: 'View' },
  { id: 'invoices.cancel', name: 'Cancel' },
  { id: 'invoices.list', name: 'List' },
  { id: 'invoices.pay', name: 'Pay' },
  { id: 'invoices.view', name: 'View' },
  { id: 'money-outflows.create', name: 'Create' },
  { id: 'money-outflows.delete', name: 'Delete' },
  { id: 'money-outflows.list', name: 'List' },
  { id: 'offices.create', name: 'Create' },
  { id: 'offices.delete', name: 'Delete' },
  { id: 'offices.edit', name: 'Edit' },
  { id: 'offices.list', name: 'List' },
  { id: 'orders.calculator', name: 'Calculator' },
  { id: 'orders.create', name: 'Create' },
  { id: 'orders.delete', name: 'Delete' },
  { id: 'orders.edit', name: 'Edit' },
  { id: 'orders.list', name: 'List' },
  { id: 'packages.delete', name: 'Delete' },
  { id: 'packages.edit', name: 'Edit' },
  { id: 'packages.list', name: 'List' },
  { id: 'packages.reception', name: 'Reception' },
  { id: 'packages.track', name: 'Track' },
  { id: 'packages.view', name: 'View' },
  { id: 'products.create', name: 'Create' },
  { id: 'products.delete', name: 'Delete' },
  { id: 'products.edit', name: 'Edit' },
  { id: 'products.list', name: 'List' },
  { id: 'reports.view', name: 'View' },
  { id: 'special-package-manifests.admin', name: 'Admin' },
  { id: 'special-package-manifests.create', name: 'Create' },
  { id: 'special-package-manifests.delete', name: 'Delete' },
  { id: 'special-package-manifests.list', name: 'List' },
  { id: 'special-package-manifests.pay', name: 'Pay' },
  { id: 'special-package-manifests.view', name: 'View' },
  { id: 'special-packages.admin', name: 'Admin' },
  { id: 'special-packages.delete', name: 'Delete' },
  { id: 'special-packages.edit', name: 'Edit' },
  { id: 'special-packages.list', name: 'List' },
  { id: 'special-packages.pre-alert', name: 'Pre-alert' },
  { id: 'special-packages.receive', name: 'Receive' },
  { id: 'unowned-packages.create', name: 'Create' },
  { id: 'unowned-packages.delete', name: 'Delete' },
  { id: 'unowned-packages.list', name: 'List' }
];
